...
public class BoardFrameClient extends JFrame implements ActionListener, WindowListener {
	...
	public BoardFrameClient (int wType, int bType, int level) {
        ...
        board=new BoardClient(wType, bType);
		...
		} else if (wType == Player.ARTIFICIAL && bType == Player.ARTIFICIAL)
			board.getRenderingThread().start();
	}
	...
	public void windowClosing(WindowEvent we) {
		...
		if (board.getRenderingThread().isAlive())
			board.setImax(0);
	}
	...
	public BoardClient getBoard() {return board;}
	...
	public void setBoard(BoardClient board) {this.board = board;}
