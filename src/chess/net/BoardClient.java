...
public class BoardClient extends JPanel implements MouseListener, MouseMotionListener {
	...
	public BoardClient(int wType, int bType) {
	...
	public static void setOffset(int offset) {BoardClient.offset = offset;}
