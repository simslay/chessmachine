...
import chess.gui.BoardUtil;
//import chess.game.players.artificial.ArtificialBlack;
import chess.gui.PieceImage;

/**
 * @author Grandsire Simon
 */

public class BoardServer extends JPanel implements MouseListener, MouseMotionListener, Runnable {
	...
	public BoardServer(int wType, int bType) {
		...
		while (true) {
			try {
				...
				for(int i=0; i<999; i++) {
					...
					System.out.println("Le client nous envoie : " + message);
					
					output.println("Bien recu.");
				}
	...
	public static void setOffset(int offset) {BoardServer.offset = offset;}
