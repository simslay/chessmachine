...
import chess.game.players.artificial.ArtificialBlack;
import chess.game.players.artificial.ArtificialWhite;

/**
 * @author Grandsire Simon
 */

public class WBoard extends java.applet.Applet implements MouseListener, MouseMotionListener {
	...
	int wType = Player.HUMAN, bType = Player.ARTIFICIAL;
	...
	public void init() {
		...
		try {
			board = ImageIO.read(getClass().getResource("images_gui/board01.png"));
			
			// chargement des images des pieces
			// pions
			wht_pwn_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_plt45.svg.png"));
			blk_pwn_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_pdt45.svg.png"));
			for (int i=0; i<8; i++) {
				wht_pwns[i] = new PieceImage(wht_pwn_img, "pwn", Game.WHITE);
				blk_pwns[i] = new PieceImage(blk_pwn_img, "pwn", Game.BLACK);
			}
			// tours
			wht_rk_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_rlt45.svg.png"));
			wht_rk1 = new PieceImage(wht_rk_img, "rok", Game.WHITE);
			wht_rk2 = new PieceImage(wht_rk_img, "rok", Game.WHITE);
			blk_rk_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_rdt45.svg.png"));
			blk_rk1 = new PieceImage(blk_rk_img, "rok", Game.BLACK);
			blk_rk2 = new PieceImage(blk_rk_img, "rok", Game.BLACK);
			// cavaliers
			wht_knt_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_nlt45.svg.png"));
			wht_knt1 = new PieceImage(wht_knt_img, "knt", Game.WHITE);
			wht_knt2 = new PieceImage(wht_knt_img, "knt", Game.WHITE);
			blk_knt_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_ndt45.svg.png"));
			blk_knt1 = new PieceImage(blk_knt_img, "knt", Game.BLACK);
			blk_knt2 = new PieceImage(blk_knt_img, "knt", Game.BLACK);
			// fous
			wht_bsp_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_blt45.svg.png"));
			wht_bsp1 = new PieceImage(wht_bsp_img, "bsp", Game.WHITE);
			wht_bsp2 = new PieceImage(wht_bsp_img, "bsp", Game.WHITE);
			blk_bsp_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_bdt45.svg.png"));
			blk_bsp1 = new PieceImage(blk_bsp_img, "bsp", Game.BLACK);
			blk_bsp2 = new PieceImage(blk_bsp_img, "bsp", Game.BLACK);
			// reines
			wht_qn_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_qlt45.svg.png"));
			wht_qn = new PieceImage(wht_qn_img, "qun", Game.WHITE);
			blk_qn_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_qdt45.svg.png"));
			blk_qn = new PieceImage(blk_qn_img, "qun", Game.BLACK);
			// rois
			wht_kng_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_klt45.svg.png"));
			wht_kng = new PieceImage(wht_kng_img, "kng", Game.WHITE);
			blk_kng_img = ImageIO.read(getClass().getResource("images_gui/200px-Chess_kdt45.svg.png"));
		...
		if (level != null && level.charAt(0) != '0') {
	...
	public static void setOffset(int offset) {WBoard.offset = offset;}
